...
def find_images_and_targets(folder, types=IMG_EXTENSIONS, class_to_idx=None, leaf_name_only=True, sort=True):
        ...
        if label!='':
            ...
            #print(label)
                ...
                for f in files:
                    ...
                    #print(os.path.join(root, f),label)
    ...
    images_and_targets = [(f, class_to_idx[l]) for f, l in zip(filenames, labels) if l in class_to_idx and f!=None]
    #print([(f, class_to_idx[l]) for f, l in zip(filenames, labels) if l in class_to_idx])
